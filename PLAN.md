...
트리거로 복귀), 데스크톱 본문에 `max-width: 68ch`(Baymard/Nielsen Norman Group —
50~75자가 가독성 최적 구간, 지금은 90~100자였음), "지난 브리핑"/"주간 회고"
시각적 구분, 아카이브 검색 로딩 상태, 유틸리티 바 좁은 화면 `flex-wrap` 안전장치.
